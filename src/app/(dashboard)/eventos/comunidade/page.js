...
function ComunidadeContent() {
  ...
  return (
    <div className="max-w-[470px] mx-auto px-4 py-4 sm:py-6">
      <Link href={`/eventos/detalhe?id=${id}`} className="flex items-center gap-2 text-gray-600 hover:text-gray-900 text-sm mb-6 transition-colors">
        <ArrowLeft size={16} />
        Voltar ao evento
      </Link>
      <h1 className="text-2xl font-bold text-gray-900 mb-1">Comunidade do Evento</h1>
      <p className="text-gray-600 text-sm mb-6">Poste, comente e torça pela sua equipe</p>

...
function ComunidadeContent() {
  ...
  return (
    <div className="max-w-[470px] mx-auto px-4 py-4 sm:py-6">
      ...
      <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-1">Comunidade do Evento</h1>
      <p className="text-gray-600 dark:text-gray-400 text-sm mb-6">Poste, comente e torça pela sua equipe</p>

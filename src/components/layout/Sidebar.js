...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden md:flex w-60 bg-white border-r border-gray-200 flex-col py-6 shrink-0">
      <div className="px-5 mb-8 flex items-center gap-2">
        <Trophy className="text-red-500" size={22} />
        <span className="text-gray-900 font-bold text-lg">Nexus Arena</span>
      </div>
